...
app.service('orderService',function($http){
	...
	//分页 
	this.findPage=function(status,page,rows){
    ...
    //分页
    this.findAllPage=function (status,pageNum,pageSize) {
        return $http.get('../order/findAllPage.do?status='+status+'&pageNum='+pageNum+'&pageSize='+pageSize)
    }
});
