...
import com.pinyougou.entity.TbUserExample;
import com.pinyougou.entity.TbUserExample.Criteria;
	 ...
	 @Override
	    public void update(TbUser user,String userName) {
	        ...
	        for (TbUser tbUser : tbUsers) {
	            ...
	            tbUser.setUpdated( user.getUpdated() );
	            tbUser.setCreated( user.getCreated() );
	           user=tbUser;
	        }
